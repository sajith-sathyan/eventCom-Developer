...
export default function Sidebar(props) {
  ...
  // path to ticket
  const pathToBasicInfo = () => {
    Navigate(`/organizations/event/${basicInfoId}/basicInfo`);
  };
  // path to event media
  const pathToEventMedia = () => {
    Navigate(`/organizations/event/${eventMediaId}/eventMedia`);
  };
  // path to tickets
  const pathToTickets = () => {
    Navigate(`/organizations/event/${basicInfoId}/tickets`);
  };
  const pathToMainHome = () =>{
    Navigate("/")
  }
              ...
              <div className="px-6 pt-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <p onClick={pathToMainHome}  className="text-bold md:text2xl text-base pl-3 text-gray-800">
                      EventCom
                    </p>
                  </div>
                  <div
                ...
                <ul className="f-m-m">
                  <a>
                    <li className="text-white pt-8">
                      {sidbarStatus.home ? (
                        <div onClick={pathToHome} className="flex items-center">
                      ...
                      {sidbarStatus.event ? (
                        ...
                        <div className="flex items-center">
                          ...
                          >
                            ...
                            <p className="text-gray-700 ml-3 text-lg">Events</p>
                          </div>
                        </div>
                      )}
                    </li>
                    <li onClick={QrCodeClick} className="text-gray-700 pt-8">
                      {" "}
                      <p className="text-gray-700 ml-3 text-lg">Qr Code</p>
                    </li>
                  </a>
                </ul>
              </div>
          ...
          <div className="justify-between container px-6 h-16 flex items-center lg:items-stretch mx-auto">
            <div className="flex items-center">
              <div className="mr-10 flex items-center">
                ...
                <h3 onClick={pathToMainHome} className="text-base text-gray-800 font-bold tracking-normal leading-tight ml-3 hidden lg:block">
                  Eventcom
                </h3>
              </div>
              <ul className="pr-32 xl:flex hidden items-center h-full">
                {sidbarStatus.home ? (
                  ...
                  <li
                    onClick={pathToHome}
                    className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 tracking-normal"
                  >
                    Dashboard
                  </li>
                )}
                {sidbarStatus.event ? (
                  <li
                    onClick={pathToEvent}
                    className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-indigo-700 mx-10 tracking-normal relative"
                  >
                    Events
                  </li>
                ) : (
                ...
                <div className="w-full h-full flex">
                  ...
                  >
                    <div className="relative">
                      <div className="cursor-pointer w-4 h-4 xl:w-auto xl:h-auto text-gray-600">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          height="30.4" // Reduced height by 20%
                          viewBox="0 -960 960 960"
                          width="30.4" // Reduced width by 20%
                        >
          ...
          <div className="bg-gray-200 w-full">
            <div className="container px-6 py-6 sm:py-0 mx-auto">
              ...
              <ul className="hidden sm:flex flex-row pt-8">
                {eventPage.basicInfo.status ? (
                  <li
                    onClick={pathToBasicInfo}
                ...
                {eventPage.eventMedia.status ? (
                  <li
                    onClick={pathToEventMedia}
                    className="rounded-t w-32 h-12 flex items-center justify-center bg-white text-sm text-gray-800"
                  >
                    Event Media
                  </li>
