...
export default function CreateSidebar(props) {
  const { sidbarStatus, eventPage ,basicInfoId,eventMediaId} = props;
          ...
          {/* <div className="bg-gray-200 w-full">
            <div className="container px-6 py-6 sm:py-0 mx-auto">
              ...
              <ul className="hidden sm:flex flex-row pt-8">
                  ...
                  <li onClick={pathToBasicInfo}  className="rounded-t w-32 h-12 flex items-center justify-center bg-gray-300 mr-1 text-sm text-gray-800">
                     Basic Info
                  </li>
                
               
                  <li onClick={pathToEventMedia} className="rounded-t w-32 h-12 flex items-center justify-center bg-gray-300 mr-1 text-sm text-gray-800">
                    Event Media
                  </li>
                
                
                  <li onClick={pathToTickets} className="rounded-t w-32 h-12 flex items-center justify-center bg-gray-300 mr-1 text-sm text-gray-800">
                    Ticket
                  </li>
