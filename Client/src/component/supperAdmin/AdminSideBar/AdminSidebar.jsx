...
const pathToUserManagement = ()=>{
  navigate("/admin/usermangement")
}

const pathToApproveEvnet = ()=>{
  navigate("/admin/eventManagement")
}
const pathToCatagoryAndType = ()=>{
  navigate("/admin/categoryAndType")
}
const pathToBanner = ()=>{
...
const LogOut = ()=>{
  ...
  const LogOut =async () =>{
 const {data} =await axiosInstance.post("/admin/LogOut",{},{withCredentials:true})
 console.log("................|||........",data)
 if(data.response){
  ...
  return (
    <>
      <div className="w-64 absolute sm:relative bg-gray-200 shadow md:h-full flex-col justify-between hidden sm:flex">
        <div className="px-8">
          <div className="h-16 w-full flex items-center">
            ...
            <h1 class="font-bold text-2xl text-blue-500">Evnet Com</h1>
          </div>
          <ul className="mt-12">
            <li 
            onClick={pathToDashboard}
            className="flex w-full justify-between text-gray-500 hover:text-blue-500 cursor-pointer items-center mb-6">
            ...
            className="flex w-full justify-between text-gray-500 hover:text-blue-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Event Management</span>
              </div>
            </li>
            <li 
            onClick={pathToCatagoryAndType}
            className="flex w-full justify-between text-gray-600 hover:text-blue-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-sm  ml-2"> Category And Type</span>
              </div>
            </li>
            <li
            onClick={pathToBanner}
            className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Banner</span>
              </div>
              {/* <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">
                25
              </div> */}
        ...
        <div className="px-8 border-t border-gray-600">
          <ul className="w-full flex items-center justify-between bg-gray-600">
      ...
      <div
        className="w-64 z-40 absolute bg-gray-200 shadow md:h-full flex-col justify-between sm:hidden  transition duration-150 ease-in-out"
        id="mobile-nav"
      >
        <div
        ...
        {show && (
          <div className="px-8">
            ...
            <ul className="mt-12">
              <li className="flex w-full justify-between text-gray-500 hover:text-blue-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="icon icon-tabler icon-tabler-grid"
              ...
              <li  className="flex w-full justify-between text-gray-500 hover:text-blue-500 cursor-pointer items-center">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="icon icon-tabler icon-tabler-settings"
